# Running Gradient average with Keras CNN in IBM federated learning
...
- Generate config files by running:
    ```
    python examples/generate_configs.py -n <num_parties> -m keras_gradient_aggregation  -d <dataset> -p <path>
    ```
